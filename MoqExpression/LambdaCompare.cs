...
namespace MoqExpression
{
    internal static class LambdaCompare
    {
        ...
        private static bool ExpressionsEqual(Expression x, Expression y, LambdaExpression rootX, LambdaExpression rootY)
        {
            ...
            {
                LambdaExpression lx = (LambdaExpression)x;
            ...
            {
                MemberInitExpression mix = (MemberInitExpression)x;
            ...
            {
                NewArrayExpression nx = (NewArrayExpression)x;
            ...
            {
                NewExpression nx = (NewExpression)x;
            ...
            {
                ConditionalExpression cx = (ConditionalExpression)x;
        ...
        private static ConstantValue TryCalculateConstant(Expression e)
        {
            ...
            {
                NewArrayExpression ae = ((NewArrayExpression)e);
